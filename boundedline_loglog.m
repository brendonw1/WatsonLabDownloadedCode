...
for iln = 1:nline
    hp(iln) = patch(log10(xp{iln}),log10(yp{iln}), ptchcol{iln}, 'facealpha', alpha{iln}, 'edgecolor', 'none');
end

for iln = 1:nline
    hl(iln) = line(log10(xl{iln}), log10(yl{iln}), 'marker', marker{iln}, 'linestyle', lnsty{iln}, 'color', lncol{iln});
end
